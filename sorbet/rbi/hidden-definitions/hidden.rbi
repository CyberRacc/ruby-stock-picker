...
class Bundler::PubGrub::Assignment
  ...
  def decision_level(); end

  def index(); end

  def initialize(term, cause, decision_level, index); end

  def term(); end
end

class Bundler::PubGrub::Assignment
  def self.decision(package, version, decision_level, index); end
end

class Bundler::PubGrub::BasicPackageSource
  def all_versions_for(package); end

  def dependencies_for(package, version); end

  def incompatibilities_for(package, version); end

  def no_versions_incompatibility_for(_package, unsatisfied_term); end

  def parse_dependency(package, dependency); end

  def root_dependencies(); end

  def sort_versions_by_preferred(package, sorted_versions); end
...
class Bundler::PubGrub::Incompatibility::ConflictCause
  def conflict(); end

  def incompatibility(); end

  def incompatibility=(_); end
...
class Bundler::PubGrub::Package
  ...
  ROOT_VERSION = ::T.let(nil, ::T.untyped)
end

class Bundler::PubGrub::Package
  def self.root(); end

  def self.root?(package); end

  def self.root_version(); end
end

class Bundler::PubGrub::PartialSolution
  def assignments(); end

  def attempted_solutions(); end

  def backtrack(previous_level); end

  def decide(package, version); end

  def decision_level(); end

  def decisions(); end

  def derive(term, cause); end

  def relation(term); end

  def satisfier(term); end

  def satisfies?(term); end
...
class Bundler::PubGrub::SolveFailure
  ...
  def initialize(incompatibility); end
end
...
class Bundler::PubGrub::StaticPackageSource::DSL
  def add(name, version, deps: T.unsafe(nil)); end

  def initialize(packages, root_deps); end
...
class Bundler::PubGrub::Term
  ...
  def initialize(constraint, positive); end
  ...
  def relation(other); end

  def satisfies?(other); end

  def to_s(allow_every: T.unsafe(nil)); end
end
...
class Bundler::PubGrub::VersionConstraint
  ...
  def allows_all?(other); end

  def allows_any?(other); end

  def any?(); end

  def constraint_string(); end
  ...
  def initialize(package, range: T.unsafe(nil)); end
...
class Bundler::PubGrub::VersionConstraint
  def self.any(package); end

  def self.empty(package); end

  def self.exact(package, version); end
end
...
class Bundler::PubGrub::VersionRange
  ...
  def compare_version(version); end

  def contiguous_to?(other); end
  ...
  def initialize(min: T.unsafe(nil), max: T.unsafe(nil), include_min: T.unsafe(nil), include_max: T.unsafe(nil), name: T.unsafe(nil)); end
  ...
  def partition_versions(versions); end

  def ranges(); end

  def select_versions(versions); end

  def span(other); end

  def strictly_higher?(other); end

  def strictly_lower?(other); end

  def union(other); end

  def upper_invert(); end
...
class Bundler::PubGrub::VersionSolver
  def initialize(source:, root: T.unsafe(nil), logger: T.unsafe(nil)); end
...
class Bundler::PubGrub::VersionUnion
  ...
  def select_versions(all_versions); end
...
class Bundler::PubGrub::VersionUnion
  def self.normalize_ranges(ranges); end

  def self.union(ranges, normalize: T.unsafe(nil)); end
end
